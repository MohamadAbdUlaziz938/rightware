...
class LocalStorage {
  ...
  Future<LocalStorage> init() async {
    permanent = LocalStorageAdapter(await (Platform.isIOS
        ? getLibraryDirectory()
...
class LocalStorageAdapter {
  ...
  scopedToUser() {
    return scopedToSubDir('mohamad abdulaziz');
  }
  ...
  deleteContents() {
    return rootDir.listSync().forEach((e) => e.deleteSync(recursive: true));
  }
}
